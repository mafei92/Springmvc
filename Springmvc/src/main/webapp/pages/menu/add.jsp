	...
	if(validate){
		$('#form1').form('submit',{
			success: function (data){
	        	...
	        	if(result == '1'){
	        		$.messager.alert('温馨提示','菜单添加成功！', 'info', function(){
	        			window.location.href = '<%=path%>/menu/queryMenu.do';
	        		});
	        	}else{
	        		$.messager.alert('温馨提示','菜单添加失败！', 'info');
	        	}
	        },
			error:function(){
...
<body style="background: #FFFFFF">
	<form id="form1" name="form1" method="post" action="<%=path%>/menu/saveMenu.do">
			...
			<table width="100%" align="center">
				...
				<tr>
					<td align="center" colspan="8">
						<a href="#" class="easyui-linkbutton" icon="icon-save" onclick="saveMenu();">保存</a>&nbsp;
